	...
	cases := []exp{
		...
		},
		{
			[]string{"ad",
				...
				"ggfee"},
			"accddfg",
			[]string{"ad", "adcagc", "adccgf", "adeeeba", "adfe", "ae", "aebcgeg", "aecccfg", "aecfc", "aeecc", "aeecdec", "aeef", "aefebfc", "aefg", "aeggca", "af", "afaabaa", "afaefe", "afffafd", "afg", "afgg", "aga", "agb", "agbeacf", "agc", "agceecf", "age", "agfcda", "aggg", "b", "ba", "baafcfc", "baafg", "babb", "bacd", "bbaccda", "bbaf", "bbeddda", "bbefe", "bc", "bcb", "bda", "bdaag", "bdc", "bddfcce", "bdf", "bdgc", "be", "bebc", "bebfgg", "befd", "begffb", "bf", "bfafd", "bfb", "bfdf", "bffa", "bffaa", "bffd", "bg", "bgbccc", "bgd", "bgfcdf", "c", "cae", "cagagec", "cbcea", "cbd", "cbdfdg", "cbgabge", "cc", "ccabbag", "ccde", "ccf", "ccffe", "ccffg", "cd", "cda", "cdd", "cdgbcge", "cdggec", "ce", "ceaadgb", "ceacfc", "cebad", "cedd", "cedfaaf", "cegeg", "cfagagd", "cfcbd", "cfdd", "cfdeac", "cfeadfd", "cfef", "cffd", "cffffb", "cfgf", "cg", "cgaaba", "cgaeg", "cgafbd", "cgbcc", "cgcbca", "cgcd", "cgcedbf", "cgdg", "cgeaeg", "cgeb", "cgeffd", "d", "da", "daa", "daf", "db", "dbacedb", "dbbc", "dbdfade", "dbegegf", "dbfac", "dbgdcfb", "dc", "dcb", "dcdfc", "dcegcg", "de", "deaeaa", "debdfc", "decd", "deceege", "degbf", "deged", "df", "dfaac", "dfdg", "dfg", "dg", "dgbefa", "dgceafc", "dgf", "e", "eaaagg", "eabab", "eb", "ebaf", "ebcea", "ebdagea", "ebdeg", "ec", "eca", "ecb", "ecbcffg", "ecbeaec", "ecdaac", "ecdcd", "ecdf", "ecfaffd", "ed", "edaag", "edbdbg", "edcdd", "edcgba", "edfdc", "edge", "edgfadd", "eeadb", "eeafcb", "eebb", "eecacge", "eeddgb", "eegda", "eegff", "ef", "efdadeb", "effdda", "efgceab", "efggf", "eg", "egaegg", "egc", "egcbgb", "egcd", "egdf", "egfdf", "eggg", "f", "fa", "fadab", "fadfag", "faf", "fafeaee", "fb", "fbabd", "fbcdba", "fbced", "fbd", "fbf", "fc", "fcbcfcd", "fccag", "fccdaca", "fcd", "fcdgfce", "fcfdec", "fcffe", "fd", "fda", "fdace", "fdbf", "fdcdf", "fdeadc", "fdegcgd", "fdfcaf", "fdgf", "fe", "febgb", "fecgba", "feda", "fedgf", "fegd", "ff", "ffagdcf", "ffagg", "ffc", "ffgcgc", "fg", "fgafcf", "fgcfa", "fgdf", "fgegde", "g", "ga", "gadbfea", "gadeg", "gaebd", "gaeeafb", "gafegf", "gbc", "gbd", "gbf", "gbgd", "gc", "gcacbg", "gcdgbeb", "gcf", "gcfd", "gcgfacg", "gd", "gdc", "gdcd", "gdd", "gddbee", "gdecgc", "gdf", "gdffed", "gdgea", "ge", "gebb", "geeaaef", "geebdef", "gfabcb", "gfbecde", "gfbedeg", "gfbf", "gfbgbcc", "gfbgea", "gfcgddb", "gfde", "gfgda", "gfgde", "gg", "ggaddb", "ggdgggb", "ggececf", "ggefde", "ggfee"},
		},
		{
			[]string{"a",
				"a",
				...
				"ggf"},
			"dddagd",
			[]string{"dddecge", "de", "def", "defdcbc", "df", "dfa", "dfabeba", "dfcaaba", "dfceg", "dfedg", "dg", "dgabadc", "dgced", "dgcggc", "e", "eaadfd", "ead", "eagbc", "eba", "ebafgd", "ebc", "ebeccbg", "ebf", "ebfb", "ecaceb", "ecafgbd", "eccfe", "ecgceg", "edbb", "edd", "eddg", "edggfcc", "ee", "eeb", "eebfffa", "efcd", "efcde", "efd", "efe", "effdgae", "egbb", "egbc", "eggf", "f", "fab", "faeae", "fbabf", "fbcgfff", "fbga", "fbgb", "fc", "fcbfcd", "fcdd", "fcfbg", "fdgcc", "fe", "fecgc", "fedcaag", "fff", "fg", "fgafg", "fgcceb", "fgddc", "fgdfcef", "fgdgedf", "g", "gabf", "gb", "gcfgefe", "gd", "gdacf", "gdc", "gdde", "gdeeegb", "gdgegea", "ge", "gea", "gef", "gfgdb", "ggad", "ggagcc", "ggb", "ggccgf", "ggebfdg", "ggf"},
		},
	}
